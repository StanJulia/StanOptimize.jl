...
init_union = Union{Nothing, StanOptimize.Init, AbstractString, Dict, Array{T, 1} where T}
...
compiling the model.
"""
function stan_sample(model::CmdStanOptimizeModel; kwargs...)
  n_chains = 4
  rm_samples = true
  diagnostics = false
...
function _stan_sample(model::CmdStanOptimizeModel; rm_samples = true)
...
"""
function stan_cmd_and_paths(model::CmdStanOptimizeModel, id::Integer)
